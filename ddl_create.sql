...
(
	...
	"REMAIN" NUMBER(8,0) DEFAULT 0 NOT NULL ENABLE, 
    PRIMARY KEY ("NUM") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 compute STATISTICS STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 buffer_pool DEFAULT) TABLESPACE "USERS" ENABLE,
...
(
	...
	"CHARGE_DATE" DATE DEFAULT SYSDATE, 
	"CASH_TYPE" VARCHAR2(50 BYTE) NOT NULL ENABLE, 
	PRIMARY KEY ("NUM") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT) TABLESPACE "USERS"  ENABLE, 
...
CREATE TABLE "BF"."ACCUSE" 
  ...
  TABLESPACE "USERS"  ENABLE, 
	 ...
	 CONSTRAINT "REVIEW_REVIEW_NUM_FK" FOREIGN KEY ("REVIEW_NUM")
	  REFERENCES "BF"."REVIEW" ("NUM") ON DELETE CASCADE ENABLE
...
CREATE TABLE "BF"."KEYWORD" 
  ...
  TABLESPACE "USERS" ;
   ...
   (	"NUM" NUMBER(8,0), 
	"KEYWORD_NUM" NUMBER(8,0) NOT NULL ENABLE, 
	"BOOK_NUM" NUMBER(8,0), 
	 PRIMARY KEY ("NUM")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS"  ENABLE, 
	 CONSTRAINT "KEYWORD_LIST_FK2" FOREIGN KEY ("BOOK_NUM")
	  REFERENCES "BF"."BOOKM" ("BOOK_NUM") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "KEYWORD_LIST_FK1" FOREIGN KEY ("KEYWORD_NUM")
	  REFERENCES "BF"."KEYWORD" ("NUM") ON DELETE CASCADE ENABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
...
CREATE SEQUENCE  "BF"."POINT_NUM_SEQ";
   CREATE SEQUENCE  "BF"."KEYWORD_NUM_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;

   CREATE SEQUENCE  "BF"."KEYWORD_LIST_NUM_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
