...
<link href="${root}/css/serviceCenter/how_use.css" type="text/css" rel="stylesheet">
		...
		<div class="service_information_content">
			<div class="service_information_content_right">
				...
				<div class="service_information_list">
					<c:forEach var="howUseDto" items="${howUseList }"	>
						<div><a href="javascript:howUseRead('${root}','${howUseDto.num}')">${howUseDto.title}</a></div>
					</c:forEach>
				</div>
			</div>
