	...
	<div id="mainHome">
		<div class="keyword">
			<ul>
				...
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">동양풍</button></li>
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">소꿉친구</button></li>
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">다정공</button></li>
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">미인수</button></li>
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">복수</button></li>
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">성장물</button></li>
			</ul>
		</div>
