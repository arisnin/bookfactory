	...
	<div id="mainHome">
		<div class="keyword">
			<ul>
				...
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">현대물</button></li>
				...
				<li><button type="button" class="bf-button keyword-btn" onclick="location.href='${root}/keyword.do?firstCate=${firstCate}'">남장여자</button></li>
