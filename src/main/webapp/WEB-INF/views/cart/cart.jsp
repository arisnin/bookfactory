...
<script type="text/javascript">
	$(function() {
		...
		$(".cart_content_sel_child input[type='checkbox']").click(function() {
			...
			if($(this).prop("checked")==true){
				$(".cart_content_book_span input[type='checkbox']").prop("checked", true);	
			}else{
				$(".cart_content_book_span input[type='checkbox']").prop("checked", false);
			}
		});
		...
		$(".cart_content_book_content").find("button").first().click(function() {
			$.get("${root}/cartWishList.do",{ num: "${book_num}" }, function(){
	...
	<div id="cart_main">
		...
		<div class="cart_content">
				...
				<div class="cart_content_book">
					<div class="book-thumbnail">
						<label class="bf-custom-checkbox cart_content_book_span">
							...
							src="https://misc.ridibooks.com/cover/1650000107/large">
					</div>
					<div class="cart_content_book_content">
						<span>콘텐츠 4.0: 4차산업혁명과 콘텐츠의 미래</span> <br> <span
							class="font_13">한국콘텐츠진흥원</span>
						<div class="float_right">
							<span class="price"></span>
							<div>
								<span class="dc-price">무료</span> <span
									class="count_percent hidden-block"></span>
							</div>
						</div>
						<br>
						<button class="bf-button bf-white-btn">위시리스트로 이동</button>
				...
				<div class="cart_content_book">
					<div class="book-thumbnail">
						<label class="bf-custom-checkbox cart_content_book_span">
							...
							src="https://misc.ridibooks.com/cover/2200011577/large">
					</div>
					<div class="cart_content_book_content">
						<span>달이 차오른다</span> <br> <span class="font_13">온누리</span>
						<div class="float_right">
							<span class="price"></span>
							<div>
								<span class="dc-price">3800원</span> <span
									class="count_percent no-discount"></span>
							</div>
						</div>
						<br>
						<button class="bf-button bf-white-btn">위시리스트로 이동</button>
			...
			<div class="cart_content_select">
				...
				<div class="cart_content_sel_button">
					...
					<button class="bf-button bf-white-btn cart_contet_sel_margin">선택
						삭제</button>
				</div>
			</div>
		</div>
		...
		<div class="cart_right_menu">
			<div class="cart_right_menu_content">
				<span class="icon-ok-circled"></span> <label>총 <strong>N권</strong>을
					선택하셨습니다.
				</label>
			</div>
			<div class="cart_right_menu_content">
				<span>총 상품금액</span> <span class="float_right">15000원</span>
			</div>
			<div class="cart_right_menu_content">
				<span>할인 가격</span> <span class="float_right">15000원</span>
			</div>

			<div class="cart_right_menu_content cart_right_menu_count">
				<span>합계</span> <span class="float_right">15000원</span>
			</div>

			<div class="cart_button_div">
				<button class="order_right_menu_paybutton bf-button bf-animated-btn"
					onclick="javascript:location.href='${root}/order.do'">선택대여하기</button>
			</div>
		</div>
	</div>
</body>
