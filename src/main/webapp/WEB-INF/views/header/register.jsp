...
<div id="hw_register" class="hw_regi_modal" onclick="closeRegi()">
	<div class="hw_register_wrap hw_animate">
		<form class="modal-content" action="${root}/member/register.do" method="post">
	...
	<script type="text/javascript">
		function doRegister(url) {
			...
			$.post(url + "/member/register.do", {username:username,password:password,requestURL:"ajax"}, function(data,status) {
