...
public class MemberDto {
	...
	public MemberDto() {}
	public MemberDto(int num, String id, String password, String email, String gender, Date register_date,
			Date birthday, String marketing_check, String ip, Date last_join, String phone) {
		super();
		this.num = num;
		this.id = id;
	...
	public String toString() {
		return "MemberDto [num=" + num + ", id=" + id + ", password=" + password + ", email=" + email + ", gender="
